...
var eventMapWithGeo = map[string]any{
	"app_id":            "<>angry-birds",
	"br_features_flash": false,
	"br_features_pdf":   true,
	"collector_tstamp":  tstampValue,
	"contexts_com_snowplowanalytics_snowplow_ua_parser_context_1": []any{map[string]any{
		"deviceFamily":     "Other",
		"osFamily":         "Windows XP",
		"osMajor":          any(nil),
		"osMinor":          any(nil),
		"osPatch":          any(nil),
		"osPatchMinor":     any(nil),
		"osVersion":        "Windows XP",
		"useragentFamily":  "IE",
		"useragentMajor":   "7",
		"useragentMinor":   "0",
		"useragentPatch":   any(nil),
		"useragentVersion": "IE 7.0",
	}},
	"contexts_org_schema_web_page_1": []any{map[string]any{
		"author":        "Fred Blundun",
		"breadcrumb":    []any{"blog", "releases"},
		"datePublished": "2014-11-06T00:00:00Z",
		"genre":         "blog",
		"inLanguage":    "en-US",
		"keywords":      []any{"snowplow", "javascript", "tracker", "event"},
	}},
	"contexts_org_w3_performance_timing_1": []any{map[string]any{
	...
	"txn_id":              41828,
	"unstruct_event_com_snowplowanalytics_snowplow_link_click_1": map[string]any{
		"elementClasses": []any{"foreground"},
...
func copyWithoutGeo(inMap map[string]any) map[string]any {
...
var unstructMap = map[string]any{"unstruct_event_com_snowplowanalytics_snowplow_link_click_1": eventMapWithGeo["unstruct_event_com_snowplowanalytics_snowplow_link_click_1"]}

var contextsArray = []any{"blog"}

var multipleContextsMap = map[string]any{"contexts_org_schema_web_page_1": []any{map[string]any{"author": "Fred Blundun", "breadcrumb": []any{"blog", "releases"}, "datePublished": "2014-11-06T00:00:00Z", "genre": "blog", "inLanguage": "en-US", "keywords": []any{"snowplow", "javascript", "tracker", "event"}}}, "contexts_org_w3_performance_timing_1": []any{map[string]any{"connectEnd": 1.415358090183e+12, "connectStart": 1.415358090103e+12, "domComplete": 0.0, "domContentLoadedEventEnd": 1.415358091309e+12, "domContentLoadedEventStart": 1.415358090968e+12, "domInteractive": 1.415358090886e+12, "domLoading": 1.41535809027e+12, "domainLookupEnd": 1.415358090102e+12, "domainLookupStart": 1.415358090102e+12, "fetchStart": 1.41535808987e+12, "loadEventEnd": 0.0, "loadEventStart": 0.0, "navigationStart": 1.415358089861e+12, "redirectEnd": 0.0, "redirectStart": 0.0, "requestStart": 1.415358090183e+12, "responseEnd": 1.415358090265e+12, "responseStart": 1.415358090265e+12, "unloadEventEnd": 1.415358090287e+12, "unloadEventStart": 1.41535809027e+12}}}

var wholeContextMap = []any{map[string]any{"author": "Fred Blundun", "breadcrumb": []any{"blog", "releases"}, "datePublished": "2014-11-06T00:00:00Z", "genre": "blog", "inLanguage": "en-US", "keywords": []any{"snowplow", "javascript", "tracker", "event"}}}
