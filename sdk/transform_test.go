...
// TODO: Figure out how to create a literal for the complicated context and unstruct fields.
/*
var expectedMap = map[string]interface{}{
        ...
        "contexts_org_schema_web_page_1" : []map[string]interface{ //HERE!!!!
        ...
        "contexts_org_w3_performance_timing_1" : []map[string]interface{}{
        ...
        "contexts_com_snowplowanalytics_snowplow_ua_parser_context_1": [map[string]interface{}{
          "useragentFamily": "IE",
          "useragentMajor": "7",
          "useragentMinor": "0",
          "useragentPatch": null,
...
/*
// Fails - next try stringifying the thing and comparing the strings??...
var expectedJson, _ = json.Marshal(strings.Replace(`{
        "geo_location" : "37.443604,-122.4124",
        "app_id" : "angry-birds",
        "platform" : "web",
        "etl_tstamp" : "2017-01-26T00:01:25.292Z",
...
func TestMapifyGoodEvent(t *testing.T) {
  ...
  // fmt.Println(tsvEvent)

  // json.Unmarshal([]byte(jsonString), &map2)
